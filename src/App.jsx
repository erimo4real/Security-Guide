...
import TokenSecurity from './pages/TokenSecurity'
...
const SECURITY_TOPICS = [
  ...
  { id: 't1', title: 'Session Management', icon: '🏨', tag: 'Token Security' },
  { id: 't2', title: 'JWT Best Practices', icon: '🛂', tag: 'Token Security' },
  { id: 't3', title: 'Token Storage', icon: '📮', tag: 'Token Security' },
  { id: 't4', title: 'CSRF & SameSite', icon: '🔄', tag: 'Token Security' },
  { id: 't5', title: 'Secure Cookie Config', icon: '🍪', tag: 'Token Security' },
]
    ...
    <>
      ...
      <nav className="nav">
        ...
        <div className="nav-tabs">
          ...
          <button className={`nav-tab ${currentSection === 'tokens' ? 'active' : ''}`} onClick={() => onNavigate('tokens')}>
            <span className="tab-dot" style={{ background: 'var(--green)' }} />
            Tokens
          </button>
        </div>
      ...
      <aside className={`sidebar ${sidebarOpen ? 'open' : ''}`}>
        ...
        <div className="sb-section">
          <div className="sb-section-label"><span className="sb-dot" style={{ background: 'var(--green)' }} />Token Security</div>
          <button className="sb-item" onClick={() => { onNavigate('tokens'); setSidebarOpen(false) }}>
            <span className="sb-ico">🏨</span>Session Management
          </button>
          <button className="sb-item" onClick={() => { onNavigate('tokens'); setSidebarOpen(false) }}>
            <span className="sb-ico">🛂</span>JWT Best Practices
          </button>
          <button className="sb-item" onClick={() => { onNavigate('tokens'); setSidebarOpen(false) }}>
            <span className="sb-ico">📮</span>Token Storage
          </button>
          <button className="sb-item" onClick={() => { onNavigate('tokens'); setSidebarOpen(false) }}>
            <span className="sb-ico">🔄</span>CSRF & SameSite
          </button>
        </div>
      </aside>
    </>
    ...
    <div>
      ...
      <div className="layout">
        <main className="main">
          ...
          {currentSection === 'tokens' && <TokenSecurity />}
        </main>
      </div>
